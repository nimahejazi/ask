...
def test_main_interactive_mode(mock_input, mock_get_provider, mock_config):
    ...
    with patch('builtins.print') as mock_print:
        ...
        mock_provider.chat.assert_any_call("hello", system_prompt="")
        mock_provider.chat.assert_any_call("how are you?", system_prompt="")
        mock_print.assert_called_with("AI Response")
